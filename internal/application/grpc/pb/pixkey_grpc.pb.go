...
const (
	PixService_RegisterPixKey_FullMethodName = "/pb.PixService/RegisterPixKey"
	PixService_Find_FullMethodName           = "/pb.PixService/Find"
)
...
type PixServiceClient interface {
	RegisterPixKey(ctx context.Context, in *PixRegistration, opts ...grpc.CallOption) (*PixKeyCreatedResult, error)
...
func (c *pixServiceClient) RegisterPixKey(ctx context.Context, in *PixRegistration, opts ...grpc.CallOption) (*PixKeyCreatedResult, error) {
...
type PixServiceServer interface {
	RegisterPixKey(context.Context, *PixRegistration) (*PixKeyCreatedResult, error)
...
func (UnimplementedPixServiceServer) RegisterPixKey(context.Context, *PixRegistration) (*PixKeyCreatedResult, error) {
...
func _PixService_RegisterPixKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PixServiceServer).RegisterPixKey(ctx, req.(*PixRegistration))
	}
...
var PixService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/application/grpc/protofiles/pixkey.proto",
}
